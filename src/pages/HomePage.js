...
import {UnorderedListOutlined, AreaChartOutlined, PieChartOutlined, EditOutlined, DeleteOutlined} from '@ant-design/icons'
    ...
    <div>
      <div className='flex m-5 justify-between'>
        ...
        <div className='flex gap-4 text-2xl'>
          ...
          <PieChartOutlined onClick={() => setViewData('table')} className='active:bg-blue-500'/>
        </div>
        <button
